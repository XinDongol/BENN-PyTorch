...
def alexnet(model_name, pretrained=None, **kwargs):
    ...
    """
    assert model_name in ['AlexNet','RealAlexNet','AllBinAlexNet'], 'No such model!'
    
    if model_name == 'AlexNet':
        model = AlexNet(**kwargs)
    elif model_name == 'RealAlexNet':
        model = RealAlexNet(**kwargs)
    elif model_name == 'AllBinAlexNet':

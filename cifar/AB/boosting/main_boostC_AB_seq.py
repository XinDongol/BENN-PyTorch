...
parser.add_argument('--root_dir', action='store', default='models_boostC_AB_seq/',
...
def update_weights(softmax_output, target, sample_weights):
	...
	sample_weights_new = 5000 * sample_weights_new / torch.sum(torch.abs(sample_weights_new))

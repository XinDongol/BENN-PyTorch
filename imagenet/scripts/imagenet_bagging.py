...
parser.add_argument('--data', action='store', default='../../imagenet/',
	help='dataset path')
...
parser.add_argument('--root_dir', action='store', default='../bagging_inde_resnet_release/',
	help='root dir for different experiments',type=str)
parser.add_argument('--record_path', action='store', default='bagging_inde_resnet_release',
	help='root dir for different experiments',type=str)
